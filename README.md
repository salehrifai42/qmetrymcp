...
> *Search QMetry project 10000 for test cases with status "Approved" and show me the first 5.*

The client will call `search_test_cases` with `{ projectId: 10000, status: ["Approved"], maxResults: 5 }` and render the response.
